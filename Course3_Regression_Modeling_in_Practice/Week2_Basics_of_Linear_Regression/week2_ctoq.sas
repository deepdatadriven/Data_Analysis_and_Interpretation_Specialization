...
/*sort data*/
proc sort; by HEADCAT;

proc freq; tables SKIPFREQ HEADCAT;
/* linear regression model: C->Q */
proc glm; model SKIPFREQ=HEADCAT/solution;
proc means; var SKIPFREQ; by HEADCAT;
proc gchart; vbar HEADCAT/discrete type=mean sumvar=SKIPFREQ;
run;
